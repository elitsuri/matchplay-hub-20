...
> MatchPlay Hub: Multiplayer matchmaking with ranking, lobby, and stats tracking
...
##  Architecture
Three-tier architecture: Rust, Bevy backend, native frontend, PostgreSQL database. Containerized with Docker.
